...
| 2026-03-14 | OTel integration | Langfuse span processor + LangChain callback handler | OpenLIT SDK auto-instrumentation | Self-hosted Langfuse needs explicit callback wiring, keeps the app on standard OpenTelemetry, and preserves manual spans |
...
| 2026-03-16 | FHIR API target | Remote Cloudflare Workers URL | Local-only FHIR sandbox | Remote is always available; no local server setup required for development or testing |
